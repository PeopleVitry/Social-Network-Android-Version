...
//private int  id_utilisateur=35;
	private  Listedamisdapter1 adapter;
//////////////////////////////////HANDLER///////////////////////////////////////////
	...
	private   Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
    	    ...
    	    getlistAmiConnecte(requetServeur(id_utilisateur))	; 
    	    	 ...
    	    	 Toast.makeText(test.this, "coucou", Toast.LENGTH_LONG).show();
    	      ...
    	      if(msg.what == 1){
    	    	 ...
    	    	 ArrayList<Ami> malistamisss1= getlistAmiConnecte(requetServeur(id_utilisateur));
    	      	...
    	      	Groupe groupe = new Groupe("Liste d'Amis Connectés" );
    	  		 ...
    	  		 adapter = new Listedamisdapter1(Listedamisdapter1.context, groupes);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		expandableList = (ExpandableListView) findViewById(R.id.expandableViewtest);
		...
		Listedamisdapter1 adapter = new Listedamisdapter1(this, groupes);
...
private void traitementconnect() {
	...
	//    HttpGet request = new HttpGet("http://10.10.120.239:8080/AndroidJAX-RS/allo");
	   HttpGet request = new HttpGet("http://"+MesPreferences.adress_ip+":8080/WebServiceVitry/listAmi/id_utilisateur-"+id_utilisateur+"");
